...
## 2. Page Structure
- `/` - Home / Welcome page with bio, photo, research interests, and recent publications
- `/cv` - CV / Resume with education and experience (stub)
- `/research` - Research interests and projects (stub)
- `/publications` - Publications list (stub)
...
- [x] Dynamic content loading from database (profile, publications)
...
|-------|------|-------------|
| id | uuid | Primary key |
| page | text | Page identifier (home, cv, research, publications, teaching, contact) |
...
- [x] Database: SaaS Supabase - stores profile, publications, cv_entries, research_projects, teaching_courses
...
- [x] Create database schema (profile, publications)
- [x] Seed initial data with profile and publications
...
- [x] Build Home page: Recent publications cards from database
...
- [x] Build Publications page with search and year filter
...
- [x] Build admin publications manager (CRUD)
